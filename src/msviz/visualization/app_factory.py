...
def create_app(
    data_path: str = "data/anonymized_runtime_data.csv",
    static_data_path: str = "data/anonymized_static_data.csv",
):
    ...
    app.layout = build_layout(
        context,
        overall_stylesheet,
        runtime_data_json=runtime_data.to_json(date_format="iso", orient="split"),
